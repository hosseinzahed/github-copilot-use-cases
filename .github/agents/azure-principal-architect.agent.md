...
tools: ['edit/editFiles', 'search', 'vscode/newWorkspace', 'execute/runInTerminal', 'vscode/runCommand', 'microsoftdocs/mcp/*', 'search/usages', 'vscode/vscodeAPI', 'read/problems', 'search/changes', 'execute/testFailure', 'browser/openBrowserPage', 'web/fetch', 'web/githubRepo', 'vscode/extensions', 'execute/runTests']
---
